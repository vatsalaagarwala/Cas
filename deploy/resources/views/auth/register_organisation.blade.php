            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-6">
                    <div class="breadcrumb_tittle">
                        <p>home > Register as an Organisation</p>
                        <h2>register</h2>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name of Organisation') }}</label>
                 ...
                 <div class="form-group row">
                    <label for="code" class="col-md-4 col-form-label text-md-right">{{ __('Organisation Type') }}</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="type">
                          ...
                          <option value="partnership">Partnersip Firm</option>
             ...
             <div class="form-group row">
                ...
                <input id="usertype" value="organisation" hidden name="usertype">
